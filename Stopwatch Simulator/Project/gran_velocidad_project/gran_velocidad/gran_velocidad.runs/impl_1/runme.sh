...
HD_PWD='H:/ENEL 384/Project/gran_velocidad_project/gran_velocidad/gran_velocidad.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gran_velocidad.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gran_velocidad.tcl -notrace
