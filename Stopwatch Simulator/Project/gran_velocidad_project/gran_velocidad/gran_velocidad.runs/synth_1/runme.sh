...
HD_PWD='H:/ENEL 384/Project/gran_velocidad_project/gran_velocidad/gran_velocidad.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gran_velocidad.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gran_velocidad.tcl
