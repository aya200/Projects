...
HD_PWD='H:/ENEL 384/Project/project_new/project_new.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_384.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_384.tcl
