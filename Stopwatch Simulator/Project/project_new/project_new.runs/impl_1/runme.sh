...
HD_PWD='H:/ENEL 384/Project/project_new/project_new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_384.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_384.tcl -notrace
