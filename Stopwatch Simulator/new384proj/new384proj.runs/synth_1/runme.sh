...
HD_PWD='I:/enel384/new384proj/new384proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic.tcl
