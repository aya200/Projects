...
set_property PACKAGE_PIN P3 [get_ports {night}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {night}]
#Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
set_property PACKAGE_PIN P4 [get_ports {hold}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hold}]
 

## LEDs
#Bank = 34, Pin name = IO_L24N_T3_34,						Sch name = LED0
set_property PACKAGE_PIN T8 [get_ports {traffic_led[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {traffic_led[0]}]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {traffic_led[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {traffic_led[1]}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports {traffic_led[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {traffic_led[2]}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
set_property PACKAGE_PIN T6 [get_ports {traffic_led[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {traffic_led[3]}]
#Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
set_property PACKAGE_PIN T5 [get_ports {traffic_led[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {traffic_led[4]}]
#Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
set_property PACKAGE_PIN T4 [get_ports {traffic_led[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {traffic_led[5]}]
...
set_property PACKAGE_PIN L3 [get_ports {c_a[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {c_a[0]}]
#Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {c_a[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {c_a[1]}]
#Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {c_a[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {c_a[2]}]
#Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {c_a[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {c_a[3]}]
#Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {c_a[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {c_a[4]}]
#Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {c_a[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {c_a[5]}]
#Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {c_a[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {c_a[6]}]
	
#Bank = 34, Pin name = IO_L16P_T2_34,						Sch name = DP
set_property PACKAGE_PIN M4 [get_ports c_a[7]]							
	set_property IOSTANDARD LVCMOS33 [get_ports c_a[7]]
