...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { push_button[0] }]; #IO_L4N_T0_D05_14 Sch=switchu
set_property src_info {type:XDC file:1 line:86 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { push_button[1] }]; #IO_L12P_T1_MRCC_14 Sch=switchl
